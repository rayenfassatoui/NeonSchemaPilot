 ...
 * Database performance monitoring and insights
 */
    ...
    <div className="container max-w-full mx-auto py-8">
      <div className="space-y-6">
        <DatabaseSummaryHeader
          ...
          description="Monitor database performance, query execution times, and identify optimization opportunities"
        />

        <Suspense fallback={<div className="animate-pulse bg-muted h-96 rounded-lg" />}>
          <PerformanceDashboard connectionString={connectionString} />
        </Suspense>
      </div>
    </div>
  );
